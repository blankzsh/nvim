...
G.g.python3_host_prog = os.getenv('PYTHON') or 'python3' -- export PYTHON=$(which python3)
...
G.opt.wrap = false
G.opt.undofile = true
G.opt.undodir = (os.getenv('HOME') or os.getenv('USERPROFILE')) .. '/.config/nvim/cache/undodir'
G.opt.viminfo = "!,'10000,<50,s10,h"
G.opt.foldenable = true
G.opt.foldmethod = 'manual'
G.opt.viewdir = (os.getenv('HOME') or os.getenv('USERPROFILE')) .. '/.config/nvim/cache/viewdir'
